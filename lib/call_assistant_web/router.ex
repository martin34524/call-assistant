defmodule CallAssistantWeb.Router do
  use CallAssistantWeb, :router

  import CallAssistantWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {CallAssistantWeb.Layouts, :root}
  ...
  scope "/admin", CallAssistantWeb.Admin do
    pipe_through [:browser, :require_authenticated_user]
  ...
  # scope "/api", CallAssistantWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:call_assistant, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: CallAssistantWeb.Telemetry
