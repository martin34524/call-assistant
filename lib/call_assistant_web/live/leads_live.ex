  ...
  def render(assigns) do
    ...
    <div class="mx-auto max-w-5xl px-4 py-10">
      ...
      <div class="mb-10 rounded-lg border border-zinc-200 bg-white p-5 shadow-sm">
        <.form for={@form} phx-change="validate" phx-submit="save" class="flex flex-wrap items-end gap-4">
          ...
          <tbody class="divide-y divide-zinc-100">
            <tr :for={lead <- @leads} id={"lead-#{lead.id}"}>
              ...
              <td class="px-4 py-3 align-top">
                ...
                <div :if={lead.timeline}>Timeline: <span class="font-medium">{lead.timeline}</span></div>
                <div :if={lead.decision_maker == true} class="text-zinc-500">Decision maker</div>
                <div :if={lead.callback_requested == true} class="text-green-700">Wants callback</div>
