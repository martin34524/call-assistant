...
#
#     PHX_SERVER=true bin/call_assistant start
#
...
if config_env() == :prod do
  ...
  config :call_assistant, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :call_assistant, CallAssistant.Mailer,
